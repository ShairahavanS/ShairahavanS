   ...
   public static void main(String[] args) 
   {
      ...
      do
      {
         ...
         if (!numeratorStr.substring(0,1).equals("q") && !numeratorStr.substring(0,1).equals("Q")) // as long as the exit condition is not met, this part is ran; if it is met, skip the rest
         {
            ...
            quotient = (double)(numerator)/denominator;  // calculate quotient
               
            if (denominator != 0)   // if the denominator is not 0, it gives the quotient
            {
               System.out.println(numerator + " / " + denominator + " = " + quotient + "."); 
            }     
            else  // if the denominator is 0, it outputs a message that you can't divide anything by 0
            {
