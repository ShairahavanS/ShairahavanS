...
/*
   ...
   until -1 is entered. and count of integers inputted is displayed.
*/
...
public class CountInt1
{
   public static void main(String[] args) 
   {
      ...
      System.out.println("Enter -1 to terminate. ");  // prints notice
      ...
      } while (number != -1);       // condition is that the loop continues until input is equal to -1
