   ...
   public static void main(String[] args) 
   {
      ...
      do // loop around entire game
      {
         ...
         do // loop around player's turn
         {
            ...
            {   
               System.out.print("Do you want to pick another card? ");
         ...
         if (playerScore < WINNING_SCORE)
         {
            ...
            {
               card = (int)(Math.random()*13);  // random card
               suit = (int)(Math.random()*4);   // random suit
               System.out.println("----------------------------------------------");
               ...
               System.out.println("The computer's score currently is " + computerScore + ".");  // informs user of computer's score
               System.out.println("----------------------------------------------\n");
            } 
      ...
      System.out.printf("\n|  A winning percentage of %5.2f%-19s|", winningPercentage, "%.");   // winning percentage of player
      System.out.printf("\n|%50s|", "");
